"""Tests for :mod:`hwid.core.impl.win32`; ``subprocess`` is mocked on any host."""

from __future__ import annotations

from typing import TYPE_CHECKING

from hwid.core.impl import win32
...
def test_win32_strips_powershell_output(mocker: MockerFixture) -> None:
    ...
    check_output = mocker.patch(
        "hwid.core.impl.win32.subprocess.check_output", return_value=f"{VALID_HWID}\r\n"
    )
